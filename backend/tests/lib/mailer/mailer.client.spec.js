...
import MailClient, { EMAIL_TYPES } from '../../../src/lib/mailer/mailer.client';
  ...
  describe('test methods', () => {
    ...
    describe('send', () => {
      ...
      it('should error when readfile template', (done) => {
        ...
        MailClient.send('teste@gmail.com', EMAIL_TYPES.secret_friend.name, {name: 'teste', friend: 'amigo',  email: 'teste@gmail.com'}, (err) => {
          expect(err).to.be.exist;
          expect(err).to.be.an.instanceof(Error);
          stub.restore();
          done();
      ...
      it('should be send email', (done) => {
        ...
        stub.callsFake((params) => {
          ...
          expect(params).to.include({to: 'teste@gmail.com', subject: EMAIL_TYPES.secret_friend.subject});
          stub.restore();
          done();
        });
        MailClient.send('teste@gmail.com', EMAIL_TYPES.secret_friend.name, {name: 'teste', email: 'teste@gmail.com'});
      });
